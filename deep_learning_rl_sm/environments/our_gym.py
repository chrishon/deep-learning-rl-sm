...
class Our_Env(Generic[ObsType, ActType]):
    ...
    @property
    def unwrapped(self) -> Our_Env[ObsType, ActType]:
        """Returns the base non-wrapped environment.

        Returns:
            Our_Env: The base non-wrapped :class:`gymnasium.Env` instance
        """
        return self
...
class Wrapper(
    Our_Env[WrapperObsType, WrapperActType],
    ...
    def __init__(self, env: Our_Env[ObsType, ActType]):
    ...
    def action_space(
        ...
        """Return the :attr:`Env` :attr:`action_space` unless overwritten then the wrapper :attr:`action_space` is
        used."""
    ...
    def observation_space(
        ...
        """Return the :attr:`Env` :attr:`observation_space` unless overwritten then the wrapper
        :attr:`observation_space` is used."""
    ...
    def reward_range(self) -> tuple[SupportsFloat, SupportsFloat]:
        """Return the :attr:`Env` :attr:`reward_range` unless overwritten then the wrapper :attr:`reward_range` is
        used."""
