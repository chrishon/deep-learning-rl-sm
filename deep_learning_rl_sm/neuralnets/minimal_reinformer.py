...
from deep_learning_rl_sm.neuralnets.minLSTM import minLSTM
from deep_learning_rl_sm.neuralnets.nets import Actor


class MinimalReinformer(nn.Module):
    def __init__(
            self,
            state_dim,
            act_dim,
        ...
        self.min_stacked = nn.Sequential(*min_blocks)
